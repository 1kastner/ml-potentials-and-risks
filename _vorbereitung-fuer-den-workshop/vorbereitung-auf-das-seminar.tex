...
Wenn Sie die Seminarmaterialien wie unter Abschnitt~\ref{sec:git-clone} angegeben unterhalb des Ordners \texttt{Eigene Dateien} abgelegt haben, 
können Sie in den Ordner \texttt{00 installations-check} navigieren und dort überprüfen, ob Sie alle Zellen ausführen können.
