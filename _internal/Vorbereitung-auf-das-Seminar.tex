...
\marginnote{%
	Falls Sie Windows 10/11 verwenden und kein Multi-User-Setup haben, können Sie den folgenden Schritt dadurch abkürzen, dass Sie die Batch-Datei \texttt{create-env.bat} auf der Wurzelebene des Projekts durch einen Doppelklick ausführen.
	Im Falle einer Nachfrage des Betriebssystems bestätigen Sie, dass Sie dem Urheber der Batch-Datei vertrauen.
}
...
\marginnote{%
	Falls Sie Windows 10/11 verwenden und kein Multi-User-Setup haben, können Sie den folgenden Schritt dadurch abkürzen, dass Sie die Batch-Datei
