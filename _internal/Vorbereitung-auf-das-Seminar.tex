...
\marginnote{%
	Falls Sie Windows 10 verwenden und kein Multi-User-Setup haben, können Sie den folgenden Schritt dadurch abkürzen, dass Sie die Batch-Datei \texttt{start-jupyterlab.bat} auf der Wurzelebene des Projekts durch einen Doppelklick ausführen.
	Dann ist auch die Wurzelebene in JupyterLab der entsprechende Ordner.
}
